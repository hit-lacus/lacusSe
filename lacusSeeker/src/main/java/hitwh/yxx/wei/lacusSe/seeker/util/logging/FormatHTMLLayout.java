 ...
 * 重写的HTMLLayout
 */
package hitwh.yxx.wei.lacusSe.seeker.util.logging;
...
public class FormatHTMLLayout extends HTMLLayout {   
   ...
   if (locationInfo) {   
    ...
    public String getHeader() {   
        ...
        sbuf.append("<head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />" + Layout.LINE_SEP);   
        ...
        sbuf.append("<th width=\"10%\"></th>" + Layout.LINE_SEP);   
        sbuf.append("<th width=\"10%\"></th>" + Layout.LINE_SEP);   
